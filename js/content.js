...
console.log("keyExpose🔑 is working!");
        ...
        for(src in js){
          ...
          try {
            ...
            if(url.search(regex) !== -1) {
              ...
              console.log(`KeyExpose: a potential API key found: ${url} it matched your search ${key}`);
            }
...
for (src in js) {
  ...
  try {
    if(url.search(/key/i) !== -1) {
      console.log(`KeyExpose: a potential API key found: ${url}`)
